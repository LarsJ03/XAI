...
export const methods = [
  {
    ...
    label: "PIECE",
    description:
      "PIECE changes meaningful image regions and searches for a combination that flips the model prediction while keeping the edit easy to inspect."
  },
  {
    id: "Min-Edit",
    label: "Min-Edit",
    description:
      "Min-Edit tries to flip the prediction with as little image change as possible, even when the smallest edit is not the most visually coherent."
  },
  {
    id: "C-Min-Edit",
    label: "C-Min-Edit",
    description:
      "C-Min-Edit also favors small edits, but adds a realism constraint so the changed image is more likely to stay visually plausible."
  },
  {
    id: "alibi-Proto-CF",
    label: "Alibi Proto-CF",
    description:
      "Alibi Proto-CF moves the image toward a representative example of the target class, balancing target success with similarity to realistic digits."
  }
];
