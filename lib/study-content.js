...
export const methods = [
  {
    ...
    label: "PIECE",
    description:
      "Edits only the most class-relevant features while keeping the rest of the image fixed."
  },
  {
    id: "Min-Edit",
    label: "Min-Edit",
    description:
      "Optimises the image directly to reach the target class with as little total pixel change as possible."
  },
  {
    id: "C-Min-Edit",
    label: "C-Min-Edit",
    description:
      "A constrained version of Min-Edit that penalises unrealistic patterns to encourage more plausible edits."
  },
  {
    id: "alibi-Proto-CF",
    label: "Alibi Proto-CF",
    description:
      "Guides the search toward a prototype of the target class, often leading to more realistic-looking counterfactuals."
  }
];
